...
import XTBRealTrading from "@/components/XTBRealTrading";
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        ...
        {/* XTB Real Trading Section */}
        {isXTBConnected && (
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <Server className="h-5 w-5" />
              <h2 className="text-xl font-semibold">XTB Real Trading</h2>
            </div>
            <XTBRealTrading className="w-full" />
          </div>
        )}
      </div>
    </DashboardLayout>
